...
\href{mailto:david.nilosek@gmail.com}{david.nilosek@gmail.com} | 207.337.3307 | 12621 55th ave se, Snohomish WA 98296  
}
...
\begin{tightemize}
	\item Fulltime contrancting with PhotonicSentry to develop and deploy a laser-based mosquito elemination system, working on the computer vision algorithms in the embedded system as well as developing the system infrastructure.
	\item Part time contracting with EarthOptics, built an system for monitoring and updating NDVI maps over target farm fields, fully cloud-based and serverless runing on AWS
